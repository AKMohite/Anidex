...
internal fun List<DataDTO>.toTopRatedEntities(page: Int) = this.map { it.toTopRatedEntity(page) }

private fun DataDTO.toTopRatedEntity(page: Int) = TopRatedAnimeEntity(
    id = 0L,
    anime_id = id!!,
    page = page
)
